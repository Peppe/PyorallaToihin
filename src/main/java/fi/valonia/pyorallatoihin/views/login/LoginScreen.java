...
public class LoginScreen extends VerticalLayout {
    ...
    public LoginScreen(PyorallaToihinUI root) {
        this.root = root;
        setMargin(true);
        addStyleName("main");
    ...
    private VerticalLayout createLayout() {
        ...
        loginToken.addStyleName("token-field");
        loginToken.focus();
        ClickListener submitButtonPressedListerner = new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                ...
                Company company = PyorallaToihinUI.get()
                        .getCompanyService().findCompany(token);
                if (company != null) {
                	PyorallaToihinUI.get().showCompany(company);
        ...
        Label ruler = new Label("<hr />", ContentMode.HTML);
    ...
    private HorizontalLayout createInfoLayout() {
        ...
        Label instructionsLabel = new Label(root.getMessages().getString(
                Messages.competition_info), ContentMode.HTML);
